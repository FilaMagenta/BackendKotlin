...
object Errors {
    ...
    val MissingNameBody = Error(11, "Request doesn't contain the required 'nif' argument.", HttpStatusCode.BadRequest)
    val MissingSurnameBody = Error(12, "Request doesn't contain the required 'nif' argument.", HttpStatusCode.BadRequest)
    val MissingEmailBody = Error(13, "Request doesn't contain the required 'nif' argument.", HttpStatusCode.BadRequest)
    val MissingPasswordBody = Error(14, "Request doesn't contain the required 'nif' argument.", HttpStatusCode.BadRequest)
